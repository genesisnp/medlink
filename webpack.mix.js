...
mix.js('resources/js/app.js', 'public/js')
    ...
    .js('resources/js/medical-appointment.js', 'public/js')
    ...
    .js('resources/views/components/prescription/prescription.js', 'public/js')
    ...
    .sass('resources/sass/patients.scss', 'public/css')
    .sass('resources/sass/custom-inputs.scss', 'public/css')
    .sass('resources/sass/medical-appointment.scss', 'public/css')
    .sass('resources/sass/video-room.scss', 'public/css')
    ...
    .sass('resources/views/components/clinic-history/clinic-history.scss', 'public/css')
    .sass('resources/views/components/prescription/prescription.scss', 'public/css')
    .sass('resources/views/components/form-query-data/form-query-data.scss', 'public/css')
    .sass('resources/views/components/share/share.scss', 'public/css')

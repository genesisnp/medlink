@push('styles')
    <link rel="stylesheet" href={{ mix('css/tabs-diary.css') }}>
@endpush
<div class="tabs">
    <div class="tabs-header">
        <span class="tabs-header-link current" data-tab="face-to-face">Presenciales</span>
        <span class="tabs-header-link" data-tab="virtual">Virtuales</span>
    </div>
      
    <div class="tabs-content">
        <div class="tabs-content__container">
            <div id="face-to-face" class="tabs-content__item current">
            ...
            <div id="virtual" class="tabs-content__item">
                <div class="tabs-timetable">
                    <div class="tabs-timetable__content">
                         <div class="tabs-timetable__item">
                             <h3 class="tabs-timetable__day">Lunes</h3>
